...
var lockCursor:boolean = false; // true works better for IE
...
//	GUI.backgroundColor.a = 0f; // Remove the default background color of GUILayout.Button
	GUILayout.Button (pic);



	// Quit button appears when built into game, not shows in Unity editor
